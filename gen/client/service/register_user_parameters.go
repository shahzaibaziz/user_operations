...
// WithUser adds the user to the register user params
func (o *RegisterUserParams) WithUser(user *models.User) *RegisterUserParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the register user params
func (o *RegisterUserParams) SetUser(user *models.User) {
	o.User = user
}
